...
(function (win) {
  ...
  */
   ...
   */
		...
		equal: function equal(otherSession) {
   ...
   * @return {function}          Returns a deregistration function for this listener.
   */
		on: function on(name, listener, registWin) {
			if (name == null) {
		...
		_on: function _on(name, listener, registWin) {
		...
		_getListeners: function _getListeners(name) {
